...
const ContactButtons = () => {
  // --- AYARLAR ---
  // WhatsApp Numaran (Başında + olmadan)
  const waNumber = "905550000000"; 
  const waMessage = "Merhaba, bilgi almak istiyorum.";
  
  // Telegram Kullanıcı Adın (@ işareti olmadan)
  const tgUsername = "kullaniciadi"; 
